...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FacePost.EventListeners.TaskCompletionListeners, FacePost", TaskCompletionListeners.class, __md_methods);
	}
	...
	public TaskCompletionListeners ()
	{
		...
		if (getClass () == TaskCompletionListeners.class) {
			mono.android.TypeManager.Activate ("FacePost.EventListeners.TaskCompletionListeners, FacePost", "", this, new java.lang.Object[] {  });
		}
	}
