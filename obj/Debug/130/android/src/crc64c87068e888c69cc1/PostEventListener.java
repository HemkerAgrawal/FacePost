...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FacePost.EventListeners.PostEventListener, FacePost", PostEventListener.class, __md_methods);
	}
	...
	public PostEventListener ()
	{
		...
		if (getClass () == PostEventListener.class) {
			mono.android.TypeManager.Activate ("FacePost.EventListeners.PostEventListener, FacePost", "", this, new java.lang.Object[] {  });
		}
	}
